...
export default function Edit({auth,post}) {
        ...
        const{data , setData, post:submitForm ,errors} = useForm({
            city: post.data.city ||'',
            loctype: post.data.loctype || 'Room',
            image: post.data.img_path||'',
            price: post.data.price||'',
            surface: post.data.surface||'',
    ...
    const handleImageUpload = (e) => {
        ...
        const submit = (e) => {
            e.preventDefault();
            submitForm(route('post.update',post.data.id));
        };
        ...
        <form onSubmit={submit}>
            <div className='border bg-gray-300 border-black rounded-3xl mt-10 h-auto w-[35rem] mb-12 '>
                ...
                <div className='mx-10 my-2 font-oswald text-xl items-center justify-center'>
                    ...
                    <div className='grid grid-cols-2 space-x-2 '>
                        ...
                        <div className='grid gap my-4 space-y-2' >
                            ...
                            <InputError message={errors.loctype} className="mt-2" />
                        </div>
                    </div>
                ...
                <div id='imgupl' className='mx-10 grid gap my-4 space-y-2 font-oswald text-xl '>
                    ...
                    <label
                        htmlFor="uploadFile1"
                        className="bg-white text-gray-500 font-semibold text-base rounded flex flex-col items-center justify-center w-full cursor-pointer border-2 border-gray-300 border-dashed mx-auto font-[sans-serif]"
                    >
                        {imagePreview ? (
                            <img
                                src={imagePreview}
                                alt="Preview"
                                className="w-[12rem] h-[10rem] justify-start object-cover rounded-md my-2"
                            />
                        ) : (
                        ...
                        />
                        <p className="text-xs font-medium text-gray-400 mt-2">only PNG and JPG.</p>
                    </label>
